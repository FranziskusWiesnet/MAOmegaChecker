...
The present proof checker was written to address an open problem, namely the characterization of all formulas in
$MA^\omega$ for which $D^{\mathbf{F}}\to D$ is provable.
